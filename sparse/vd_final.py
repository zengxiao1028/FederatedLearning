...
class Conv2d(nn.Conv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,padding=0, dilation=1, bias=False):
        super(Conv2d, self).__init__(in_channels, out_channels, kernel_size, stride=1, padding=padding, dilation=dilation, bias = bias)
    ...
    def conv2d_noisy(self, input):
        ...
        conved_mu = F.conv2d(input, self.weight, self.bias, self.stride, self.padding, self.dilation)
        ...
        conved_si = F.conv2d(input_square, w_square_alpha, None, self.stride, self.padding, self.dilation)
